...
from start_point.src.pet_shop import add_or_remove_cash, add_pet_to_customer, add_pet_to_stock, find_pet_by_name, get_customer_cash, get_customer_pets_count, get_pet_shop_name, get_pets_by_breed, get_pets_sold, get_stock_count, get_total_cash, increase_pets_sold, remove_customer_cash, remove_pet_by_name
import unittest
...
class TestPetShop(unittest.TestCase):
    ...
    def test_customer_pet_count(self):
        count = get_customer_pets_count(self.customers[0])
